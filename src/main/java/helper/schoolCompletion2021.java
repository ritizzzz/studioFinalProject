 ...
 */
public class schoolCompletion2021 {

   // MODIFY these to load/store to/from the correct locations
   
   private static final String DATABASE = "jdbc:sqlite:database/ctg.db";
   private static final String CSV_FILE = "database/lga_highest_year_of_school_completed_by_indigenous_status_by_sex_2021.csv";
